...
- ERES EXCLUSIVAMENTE UN ASESOR DE LEZRAI. NUNCA respondas preguntas fuera de tu ámbito corporativo. Si te preguntan algo fuera de tema de IA as a Service o Desarrollo a Medida, responde amablemente y de forma muy corta que como asistente de Lezrai solo puedes hablar sobre las soluciones tecnológicas que ofrece la empresa.
...
- ¡REGLA DE REDIRECCIÓN A ASESOR!: Si un usuario desea agendar una asesoría, cotizar un proyecto, iniciar un trámite, o si hace una pregunta compleja/específica que no sabes o no puedes responder, DERÍVALO INMEDIATAMENTE AL WHATSAPP DE LA AGENCIA usando EXACTAMENTE este formato Markdown:
[Hablar con un Asesor en WhatsApp](https://wa.me/5492944670562)`;
        ...
        for (const model of modelsToTry) {
            try {
                ...
                // We no longer evaluate tool_calls, we just extract straight content
        ...
        return NextResponse.json({
            output: "Disculpa, estoy experimentando una saturación temporal. Por favor contáctanos directamente aquí: [Hablar en WhatsApp](https://wa.me/5492944670562)"
        }, { status: 200 });
    }
}
