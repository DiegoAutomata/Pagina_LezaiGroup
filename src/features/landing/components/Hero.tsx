    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none bg-white dark:bg-[#0A0A0A]">
                <div className="absolute inset-0 bg-grid-pattern opacity-30 dark:opacity-20 z-0 sm:animate-bg-grid" />

                <div
                    className="absolute -top-[50%] -left-[50%] w-[200%] h-[200%] hidden md:block opacity-10 dark:opacity-25 mix-blend-multiply dark:mix-blend-screen blur-[80px]"
                    style={{
                        backgroundImage: `
