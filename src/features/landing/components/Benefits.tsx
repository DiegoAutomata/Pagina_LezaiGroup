                ...
                >
                    <motion.div variants={itemVariants} className="text-center space-y-4">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                            ...
                            <span className="text-brand-cyan font-semibold">Recupera hasta 25+ horas semanales</span>{' '}
                        ...
                        {mainServices.map((service, index) => (
                            ...
                            >
                                <div className="space-y-4 flex flex-col h-full">
                                    <div>
                                        <service.icon className="w-10 h-10 text-brand-orange" />
                                    </div>
                                    <h3 className="text-2xl font-display font-bold text-dark-950 dark:text-white">
                                        {service.title}
                                    </h3>
                                    {service.subtitle && (
                                        <p className="font-semibold text-gray-700 dark:text-gray-200">{service.subtitle}</p>
                                    )}
